...
curl -o "$sysrestart_path" "$repo/$branch/$sysrestart_name"
...
sudo chmod 644 "$bashrc_path"
sudo chown "$USER" "$bashrc_path"
...
sudo chmod 644 "$bashalias_path"
sudo chown "$USER" "$bashalias_path"
...
sudo chmod 644 "$bashfunctions_path"
sudo chown "$USER" "$bashfunctions_path"
