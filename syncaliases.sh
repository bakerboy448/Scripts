...
sudo wget --progress=bar -O "$sysrestart_path" "'$repo/$branch/$sysrestart_name'"
...
sudo wget --progress=bar -O "$bashrc_path" "'$repo/$branch/$bashrc_name'"
...
sudo wget --progress=bar -O "$bashalias_path" "'$repo/$branch/$bashalias_name'"
...
sudo wget --progress=bar -O "$bashfunctions_path" "'$repo/$branch/$bashfunctions_name'"
...
sudo wget --progress=bar -O "$bashalias_path" "'$repo/$branch/$fuck_unattended'"
